...
int x1;
#if USE_FMOD
extern FMOD_SOUND *otom[6];
extern FMOD_SOUND *oto[19];
#else
extern Mix_Music *otom[6];
extern Mix_Chunk *oto[19];
extern Mix_Chunk *otofinal;
#endif
...
//oto[2] = LoadSoundMem( "SE/1.mp3" ) ;
    otom[1] = LoadMusicMem(GAMEDATA"/BGM/field.ogg"); //50
    otom[2] = LoadMusicMem(GAMEDATA"/BGM/dungeon.ogg"); //40
    otom[3] = LoadMusicMem(GAMEDATA"/BGM/star4.ogg"); //50
    otom[4] = LoadMusicMem(GAMEDATA"/BGM/castle.ogg"); //50
    otom[5] = LoadMusicMem(GAMEDATA"/BGM/puyo.ogg"); //50
//otom[6]=LoadMusicMem( GAMEDATA"/BGM/last.ogg");
//ChangeVolumeSoundMem(50, otom[6]);

    oto[1] = LoadSoundMem(GAMEDATA"/SE/jump.ogg");
	otofinal = LoadSoundMem(GAMEDATA"/SE/gameover.ogg");
//oto[2] = LoadSoundMem(GAMEDATA"/SE/brockcoin.ogg");
    oto[3] = LoadSoundMem(GAMEDATA"/SE/brockbreak.ogg");
    oto[4] = LoadSoundMem(GAMEDATA"/SE/coin.ogg");
    oto[5] = LoadSoundMem(GAMEDATA"/SE/humi.ogg");
    oto[6] = LoadSoundMem(GAMEDATA"/SE/koura.ogg");
    oto[7] = LoadSoundMem(GAMEDATA"/SE/dokan.ogg");
    oto[8] = LoadSoundMem(GAMEDATA"/SE/brockkinoko.ogg");
    oto[9] = LoadSoundMem(GAMEDATA"/SE/powerup.ogg");
    oto[10] = LoadSoundMem(GAMEDATA"/SE/kirra.ogg");
    oto[11] = LoadSoundMem(GAMEDATA"/SE/goal.ogg");
    oto[12] = LoadSoundMem(GAMEDATA"/SE/death.ogg");
    oto[13] = LoadSoundMem(GAMEDATA"/SE/Pswitch.ogg");
    oto[14] = LoadSoundMem(GAMEDATA"/SE/jumpBlock.ogg");
    oto[15] = LoadSoundMem(GAMEDATA"/SE/hintBlock.ogg");
    oto[16] = LoadSoundMem(GAMEDATA"/SE/4-clear.ogg");
    oto[17] = LoadSoundMem(GAMEDATA"/SE/allclear.ogg");
    oto[18] = LoadSoundMem(GAMEDATA"/SE/tekifire.ogg");
